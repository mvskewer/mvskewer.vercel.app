...
export default function Page(props: { description: string; title: string; faviconPath?: string; h1?: string; h2?: string; h3?: string; h4?: string; h5?: string; h6?: string; children: any }) {
	return (
		<>
			<Head>
				<meta charSet="UTF-8" />
